...
char weaponsNames[200][50] = {
    ...
    "Spiked Boko Club","Dragonbone Boko Club","Lizal Boomerand","Lizal Forked Boomerang",
    ...
    "M. Sword (Broken, no malice)","M. Sword (Broken, malice)","Demon Carver","Lantern",
    "OH Obliterator","OH Obliterator(?)","Traveler's Claymore","Soldier's Claymore",
    ...
    "Savage Lynel Spear","Rusty Halberd","Farmer's Pichfork","Ancient Spear",
    ...
    "Falcon Bow","Ancient Bow","Mighty Lynel Bow","Dragon Bone Boko Bow",
